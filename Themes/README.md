...
Installed builds discover the files in `Themes/Bundled` automatically. Portable builds can use the same directory layout. To modify a bundled palette, copy or import it into the per-user `Themes` directory; a user file with the same filename takes precedence.
