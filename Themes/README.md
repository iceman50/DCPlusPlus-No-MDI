...
Installed and portable builds discover XML files placed directly in `Themes`. To modify a distributed palette, copy or import it into the per-user `Themes` directory; a user file with the same filename takes precedence.
