...
TTHValue tiger(const PathT& path) {
...
template<class InStreamT, class OutStreamT>
void runTransfer(InStreamT& inStream, OutStreamT& outStream, const size_t bufSize = 64 * 1024) {
	try {
		while(true) {
