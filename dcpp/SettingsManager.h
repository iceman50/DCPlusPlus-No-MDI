...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		LINK_FONT, LOG_FONT, CHAT_TIMESTAMP_FONT, CHAT_NICK_FONT, CHAT_TEXT_FONT, CHAT_SYSTEM_FONT,
		CHAT_OWN_TIMESTAMP_FONT, CHAT_OWN_NICK_FONT, CHAT_OWN_TEXT_FONT, CHAT_MENTION_FONT,
		ADLSEARCHFRAME_ORDER, ADLSEARCHFRAME_WIDTHS,
		BBSFRAME_BOARDS_ORDER, BBSFRAME_BOARDS_WIDTHS, BBSFRAME_ENTRIES_ORDER, BBSFRAME_ENTRIES_WIDTHS,
		...
		LANGUAGE, TOOLBAR, LAST_SEARCH_TYPE, MAPPER, MAPPER6, EMOTICON_PACK, ICON_PACK,
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		DOWNLOAD_BG_COLOR, LINK_COLOR, LINK_BG_COLOR, LOG_COLOR, LOG_BG_COLOR,
		SYSTEM_LOG_VERBOSE_COLOR, SYSTEM_LOG_INFO_COLOR, SYSTEM_LOG_WARNING_COLOR, SYSTEM_LOG_ERROR_COLOR,
		SYSTEM_LOG_AREA_COLOR,
		CHAT_TIMESTAMP_COLOR, CHAT_TIMESTAMP_BG_COLOR, CHAT_NICK_COLOR, CHAT_NICK_BG_COLOR,
		CHAT_TEXT_COLOR, CHAT_TEXT_BG_COLOR, CHAT_SYSTEM_COLOR, CHAT_SYSTEM_BG_COLOR,
		CHAT_OWN_TIMESTAMP_COLOR, CHAT_OWN_TIMESTAMP_BG_COLOR, CHAT_OWN_NICK_COLOR, CHAT_OWN_NICK_BG_COLOR,
		CHAT_OWN_TEXT_COLOR, CHAT_OWN_TEXT_BG_COLOR,
		CHAT_MENTION_COLOR, CHAT_MENTION_BG_COLOR,
		EMOTICON_SIZE, EMOTICON_BIT_DEPTH, HUB_USER_ICON_SIZE,
		...
		MAX_FILELIST_SIZE, MAX_HASH_SPEED, HASHING_THREADS, MAX_MESSAGE_LINES, MAX_PM_WINDOWS, MIN_MESSAGE_LINES,
	...
	static constexpr int HASHING_THREADS_MIN = 1;
	static constexpr int HASHING_THREADS_MAX = 64;
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		/** Negotiate ADC RTF0 and render its complete safe CommonMark dialect. */
		ENABLE_RICH_TEXT,
		/** Parse supported chat shortcuts into semantic emoticon tags. */
		ENABLE_EMOTICONS,
		...
		BROAD_DETECTION, BROAD_DETECTION6, HASH_DB_VERIFY_STARTUP, HASH_DB_COMPACT_ON_REBUILD,
		SHARE_CACHE, ENABLE_RTF_TEMP_SHARES, RTF_DROPPED_IMAGES_INLINE,
		PREFER_ZSTD, FILELIST_CACHE,
		BOOL_LAST };
	...
	enum FloatSetting { FLOAT_FIRST = INT64_LAST + 1,
		BBSFRAME_PANED_POS = FLOAT_FIRST, BBSFRAME_CONTENT_PANED_POS, FILE_LIST_PANED_POS, HUB_PANED_POS, QUEUE_PANED_POS, SEARCH_PANED_POS,
		TRANSFERS_PANED_POS, USERS_PANED_POS, STATS_PANED_POS,
