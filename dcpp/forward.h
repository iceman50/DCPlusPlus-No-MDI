...
typedef intrusive_ptr<FinishedFileItem> FinishedFileItemPtr;

class FinishedUserItem;
typedef intrusive_ptr<FinishedUserItem> FinishedUserItemPtr;
...
class SearchResult;
typedef intrusive_ptr<SearchResult> SearchResultPtr;
...
class User;
typedef intrusive_ptr<User> UserPtr;
